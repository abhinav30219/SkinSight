"""
Adapter for ConvNeXt model for skin lesion diagnosis.
Provides functionality to fine-tune and use the ConvNeXt model.
"""
...
class ConvNextDiagnostic:
    """ConvNeXt model for skin lesion diagnosis."""
    ...
    @classmethod
    def from_pretrained(cls, model_path: str, device: str = "mps") -> "ConvNextDiagnostic":
        ...
        if config_path.exists():
            ...
            model_name = config.get("model_name", "facebook/convnext-base-224")
...
def prepare_model(
    ...
    """Prepare ConvNeXt model for fine-tuning."""
    return ConvNextDiagnostic(
